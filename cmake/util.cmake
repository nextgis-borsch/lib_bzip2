...
function(check_version major minor rev)
    ...
    set(VERSION_FILE ${CMAKE_CURRENT_SOURCE_DIR}/bzlib_private.h)

    file(READ ${VERSION_FILE} _VERSION_H_CONTENTS)

    string(REGEX MATCH "BZ_VERSION[ \t\"]+([0-9].[0-9].[0-9]+)"
      _VERSION ${_VERSION_H_CONTENTS})
    string (REGEX MATCH "([0-9].[0-9].[0-9]+)"
      _VERSION ${_VERSION})

    string(REPLACE "." ";" VER_LIST ${_VERSION})

    list(GET VER_LIST 0 _MAJOR_VERSION)
    list(GET VER_LIST 1 _MINOR_VERSION)
    list(GET VER_LIST 2 _PATCH_VERSION)
